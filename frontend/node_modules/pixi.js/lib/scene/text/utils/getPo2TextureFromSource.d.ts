 ...
 * @internal
 */
export declare function getPo2TextureFromSource(image: ImageLike | HTMLCanvasElement | ICanvas, width: number, height: number, resolution: number, autoGenerateMipmaps?: boolean, scaleMode?: SCALE_MODE): Texture;
