...
class AlphaMaskEffect extends FilterEffect.FilterEffect {
  constructor() {
    ...
    this._placeholderSprite = new Sprite.Sprite(Texture.Texture.EMPTY);
   ...
   */
  reset() {
    this._placeholderSprite.texture = Texture.Texture.EMPTY;
...
class AlphaMaskPipe {
  ...
  postrender() {
    ...
    for (let i = 0; i < effects.length; i++) {
      PoolGroup.BigPool.return(effects[i]);
    }
    effects.length = 0;
  }
  destroy() {
