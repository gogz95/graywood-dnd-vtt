...
class RenderTargetSystem {
  ...
  isFrontFaceInverted(renderTarget, flipY) {
    ...
    return !!flipY !== (this._renderer.type === types.RendererType.WEBGL && !renderTarget.isRoot);
  }
  /**
  ...
  get frontFaceInverted() {
    deprecation.deprecation(deprecation.v8_21_0, "RenderTargetSystem.frontFaceInverted is deprecated, use isFrontFaceInverted() instead");
