...
var CanvasPool = require('../texture/CanvasPool.js');
var TexturePool = require('../texture/TexturePool.js');
...
const _ViewSystem = class _ViewSystem {
  ...
  destroy(options = false) {
    ...
    TexturePool.TexturePool.removeScreen(this._renderer.uid);
    CanvasPool.CanvasPool.removeScreen(this._renderer.uid);
  ...
  _updateScreenSize() {
    ...
    TexturePool.TexturePool.setScreenSize(uid, pixelWidth, pixelHeight);
    CanvasPool.CanvasPool.setScreenSize(uid, pixelWidth, pixelHeight);
  }
};
/** @ignore */
