...
class CanvasPoolClass {
  ...
  get enableFullScreen() {
    deprecation.deprecation(deprecation.v8_21_0, "CanvasPool.enableFullScreen is no longer used, the pool sizes canvases to the screens registered with setScreenSize.");
  ...
  getOptimalCanvasAndContext(minWidth, minHeight, resolution = 1) {
    ...
    if (canvasWidth > maxKeyDimension || canvasHeight > maxKeyDimension) {
      warn.warn(`CanvasPool: ${canvasWidth}x${canvasHeight} is larger than the ${maxKeyDimension}px pool key limit, canvases of this size may be pooled together`);
    }
