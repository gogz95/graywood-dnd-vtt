...
class GpuDeviceSystem {
  ...
  _setGpu(gpu) {
    ...
    if (!this._options.gpu) {
      void gpu.device.lost.then(() => this._restoreDevice()).catch((e) => warn.warn("WebGPU device was lost and could not be restored", e));
    }
