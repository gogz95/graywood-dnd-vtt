<script lang="ts">
  ...
  import {
    ...
    autoReconnect,
    toggleBlackOrb,
  } from '../frontend/src/stores/characterStore';
  import {
    initWebSocket,
    isWsConnectedStore,
    campaignDateStore,
    sendWsEvent,
  } from '../frontend/src/stores/websocketStore';
  import { soundboard, dispatchSoundEvent } from './lib/audio/soundboardBridge';

  // Core Components
  import ClaimModal from '../frontend/src/components/ClaimModal.svelte';
  import CharacterHeader from '../frontend/src/components/CharacterHeader.svelte';
  import CurrencyAssayDrawer from './lib/components/economy/CurrencyAssayDrawer.svelte';
  import InventoryList from '../frontend/src/components/InventoryList.svelte';
  import BlackOrbOverlay from '../frontend/src/components/BlackOrbOverlay.svelte';
  ...
  onMount(async () => {
    ...
    try {
      ...
      // Keep default canonical date on initial load
    }
