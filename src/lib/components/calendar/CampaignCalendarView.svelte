  ...
  <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
    ...
    <div class="lg:col-span-5 space-y-4">
      <div class="bg-dark-900 border border-amber-900/40 rounded-2xl p-4 shadow-xl space-y-3">
        ...
        <div class="space-y-2.5">
          <div>
            <label for="new-log-title-src" class="text-[10px] font-bold text-slate-400 uppercase block mb-1">
              Event Title
            </label>
            <input
              id="new-log-title-src"
              type="text"
          ...
          <div>
            <label for="new-log-details-src" class="text-[10px] font-bold text-slate-400 uppercase block mb-1">
              Historical Details / Reagents Gathered
            </label>
            <textarea
              id="new-log-details-src"
              rows="4"
